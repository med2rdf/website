...
(C) 2018 Toshiaki Katayama, updated for the med2rdf project
...
<!DOCTYPE xsl:stylesheet [
  ...
  <!ENTITY m2r		"http://med2rdf.org/ontology/med2rdf#">
  <!ENTITY spin         "http://spinrdf.org/spin#">
]>
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:taxo="http://purl.org/rss/1.0/modules/taxonomy/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:owl="http://www.w3.org/2002/07/owl#" xmlns:rdfs="http://www.w3.org/2000/01/rdf-schema#" xmlns:dc="http://purl.org/dc/elements/1.1/">
  ...
  <!-- global variables and functions -->
	...
	<xsl:template match="rdf:RDF">
		<table id="header">
			<tr>
				...
				<td id="trail">
					Med2RDF: Biomedical RDF resources
				</td>
				<td id="menu">
					<a href="http://med2rdf.org/ontology/med2rdf.ttl">Turtle</a>
					&#183; <!-- middot -->
					<a href="http://med2rdf.org/ontology/med2rdf.rdf">RDF/XML</a>
					&#183; <!-- middot -->
					<a href="http://bio2rdf.org" rel="help">Bio2RDF project</a>
				</td>
			</tr>
		</table> <!-- end of header -->
                 <table id="search">
	...
	<xsl:template name="url">
		...
		<xsl:choose>
			...
			<xsl:when test="$ns='&m2r;'">
				<a href="{concat($ns,$name)}">
					m2r:<xsl:value-of select="$name" />
				</a>
			</xsl:when>
	...
	<xsl:template name="prettyUrl">
		...
		<xsl:choose>
			...
			<xsl:when test='starts-with($name, "&m2r;")'>
				m2r:<xsl:value-of select='substring-after($name, "&m2r;")' />
			</xsl:when>
